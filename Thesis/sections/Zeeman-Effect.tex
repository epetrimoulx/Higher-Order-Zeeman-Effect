...
\chapter{The Higher Order Zeeman Effect}\label{sec:Zeeman-Effect}
    ...
    \section{The Cubic Zeeman Effect}
        ...
        \subsection{The relativistic correction to $^3$He$^+$}\label{sec:Relativistic_Correction}
            ...
            \begin{align}
                C_{\text{rel}}^{(2)} = -\frac{1}{2} \gamma^2 \frac{\mu_B}{mc^2} \left(\frac{\bar{a}_0}{Z}\right)^{\frac{7}{2}} \vec{\sigma} \cdot \vec{B} \;. \label{eq:C_rel_2}
            \end{align}
            ...
            \begin{align}
                C_{\text{rel}}^{(2)} = -\frac{1}{2} \frac{\mu_B}{m^2 c^2} g_s m_s \left(\frac{Z}{\bar{a}_0}\right)^{\frac{7}{2}} B^3 e^2\;.
            \end{align}
