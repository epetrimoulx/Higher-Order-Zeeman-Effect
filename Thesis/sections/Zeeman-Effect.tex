...
\chapter{The Higher Order Zeeman Effect}\label{sec:Zeeman-Effect}
    ...
    \section{The Zeeman effect}\label{sec:quadratic_zeeman}
        ...
        \begin{align}
            \sum_{j = 0}^\infty \left[ Z(j - 1)a_{j-1} - \frac{j(j+1)}{2}a_j \right]r^{j-2} = -\left(\frac{B^2e^2}{8m_e}r^2 - E^{(1)} \right) \frac{1}{\sqrt{\pi}}\;.\label{eq:Result_r^2_sum}
        \end{align}
        ...
        \begin{align}
            \vert \psi^{(1)} \rangle = \sum_{j = 0}^\infty a_j r^j e^{-Zr} = a_0 e^{-Zr} -\frac{1}{8} \gamma^2 \frac{1}{Z^2 \sqrt{\pi}} r^2 e^{-Zr} -\frac{1}{24Z\sqrt{\pi}} \gamma^2 r^3 e^{-Zr}\;.
        \end{align}
        ...
        \small
        \begin{align}
            \langle \psi^{(0)} \vert \psi^{(1)} \rangle = \int_0^\infty \int_0^\pi \int_0^{2\pi} r^2 \sin \theta \left(a_0 -\frac{1}{8} \gamma^2 \frac{1}{\sqrt{\pi}} \left[\frac{1}{Z^2} r^2 +\frac{1}{3Z} r^3\right] \right) \frac{Z^{\frac{3}{2}} e^{-2Zr}}{\sqrt{\pi}} = 0\;.
        \end{align}
        \normalsize
        ...
        \begin{align}
            a_0 = \frac{11}{2 Z^4 \sqrt{\pi}} \frac{1}{8}\gamma^2 \;.
        \end{align}
        ...
        \begin{align}
            \vert \psi^{(1)} \rangle = \frac{1}{8}\gamma^2 \frac{1}{\sqrt{\pi}} \left[\frac{11}{2 Z^4} - \frac{1}{Z^2} r^2 -\frac{1}{3Z} r^3 \right] e^{-Zr} \;.
        \end{align}
